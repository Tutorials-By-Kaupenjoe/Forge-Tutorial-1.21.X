...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes() {
        ...
        shapeless(RecipeCategory.MISC, ModItems.ALEXANDRITE.get(), 32)
                ...
                .save(this.output, TutorialMod.MOD_ID + ":alexandrite_from_magic_block");
        ...
        trimSmithing(ModItems.KAUPEN_SMITHING_TEMPLATE.get(), ResourceKey.create(Registries.RECIPE,
                ResourceLocation.parse(getItemName(ModItems.KAUPEN_SMITHING_TEMPLATE.get()) + "_smithing_trim")));
    }
